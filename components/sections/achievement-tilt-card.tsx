...
const accentStyles: Record<
  AchievementCategory,
  { corner: string; dot: string; label: string; divider: string; shadow: string }
> = {
  award: {
...
export function AchievementTiltCard({ achievement }: { achievement: Achievement }) {
    ...
    >
      ...
      >
        ...
        <div className="relative z-10 flex flex-col items-center text-center w-full flex-1">
          {/* Corner — top-left */}
          <div className={`absolute -top-7 -left-7 w-8 h-8 border-t-2 border-l-2 ${accent.corner}`} aria-hidden="true">
            <div className={`absolute -bottom-[3px] -right-[3px] w-[7px] h-[7px] ${accent.dot} rotate-45`} />
          </div>
          {/* Corner — top-right */}
          <div className={`absolute -top-7 -right-7 w-8 h-8 border-t-2 border-r-2 ${accent.corner}`} aria-hidden="true">
            <div className={`absolute -bottom-[3px] -left-[3px] w-[7px] h-[7px] ${accent.dot} rotate-45`} />
          </div>
          {/* Corner — bottom-left */}
          <div className={`absolute -bottom-7 -left-7 w-8 h-8 border-b-2 border-l-2 ${accent.corner}`} aria-hidden="true">
            <div className={`absolute -top-[3px] -right-[3px] w-[7px] h-[7px] ${accent.dot} rotate-45`} />
          </div>
          {/* Corner — bottom-right */}
          <div className={`absolute -bottom-7 -right-7 w-8 h-8 border-b-2 border-r-2 ${accent.corner}`} aria-hidden="true">
            <div className={`absolute -top-[3px] -left-[3px] w-[7px] h-[7px] ${accent.dot} rotate-45`} />
          </div>
          ...
          {/* Category label */}
          <p className={`text-xs font-bold tracking-[0.2em] uppercase ${accent.label}`}>
            {categoryLabels[achievement.category]}
          </p>
          <p className="text-zinc-500 text-xs italic mt-1 mb-5" aria-hidden="true">for</p>
          ...
          {/* Divider */}
          <div className={`w-16 h-px ${accent.divider} mb-4`} aria-hidden="true" />
