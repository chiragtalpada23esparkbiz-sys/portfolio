              ...
              >
                ...
                >
                  <a
                    ...
                    onClick={() => posthog.capture("hero_gmail_clicked")}
                  >
                    Gmail
                  </a>
                </Button>
                ...
                >
                  <a
                    ...
                    rel="noopener noreferrer"
                    suppressHydrationWarning
                    onClick={() => posthog.capture("hero_linkedin_clicked")}
                  >
                    LinkedIn
                  </a>
                </Button>
                <Button
                  ...
                  asChild
                >
                  <a href={personal.cv} download suppressHydrationWarning onClick={() => posthog.capture("resume_downloaded")}>
          ...
          <BlurFade delay={0.2} direction="right">
            <div className="relative flex justify-center lg:justify-end">
              <figure className="relative">
                ...
                <button
                  suppressHydrationWarning
                  onClick={() => { openChat(); posthog.capture("chat_opened", { source: "hero_profile_image" }); }}
